...
<html>
  ...
  <body>
    ...
    <center>
    <div class="hero">
      <h1 class="hero__title">This is meant to test kubernertes autoscaling functions</h1><br>
      <h3 class="hero__title">This may crash the nginx server.<br>Use with caution</h3>
